<template>
    <div class="commission br4">
        <!--搜索-->
        <Search
            :searchOPtions=searchOPtions
            @searchCallback=handelSearch>
<!--            <Export :exportOptions="exportOptions" :query="query" :url="$api.finance.withdraw.export" v-permission="[$api.finance.withdraw.export]"/>-->
...
<!--                    <el-table-column label="交易单号" show-overflow-tooltip/>-->
                    ...
                    <el-table-column label="提现银行卡" prop="bank_card" width="150" show-overflow-tooltip/>
                    <!--end -->
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <span
                                ...
                                v-if="scope.row.status != 2 && scope.row.status != 3 && scope.row.status !=10 && scope.row.status !=9">
                            审核
                        </span>
...
<script>
    ...
    import Details from './components/commissionDetail';
                ...
                searchOPtions: [
                    {
                        ...
                        key: 'pay_type',
                        placeholder: '提现方式',
                        options: [...finance.COMMISSION_RECHARGE_TYPES]
                    }, {
                        type: 'select',
                        key: 'status',
                        placeholder: '提现状态',
                        options: [...finance.COMMISSION_WITHDRAW_STATUS]
                    }, {
                        type: 'datetimerange',
                        key: 'start_at-end_at',
                        placeholder: '提现时间'
        ...
        methods: {
            ...
            statusFormat(status) {
                switch (status) {
                    ...
                    case '6': return '银行退回';
                    case '7': return '微信拒绝';
                    case '9': return '旺旺薪处理中';
                    case '10': return '旺旺薪退回';
                }
            },
