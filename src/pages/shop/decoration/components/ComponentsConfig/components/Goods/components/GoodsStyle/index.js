...
export default class GoodsStyle extends PureComponent {
    ...
    render() {
        const { formChange, content, isKill, templateId } = this.props
        ...
        console.log("style>content", templateId)
        return (
            <Form {...formItemLayout}>
                <Block title="显示设置">
                    <Row>
                    ...
                    <Form.Item labelCol={{ span: 5 }} wrapperCol={{ span: 19 }} label="购买按钮">
                        <Radio.Group value={templateId === 1 ? 3 : bottomBtnType} onChange={e => { templateId !== 1 && formChange('bottomBtnType', e.target.value) }}>
                       ...
                       templateId !==1 && bottomBtnType === 2 &&
                        <Fragment>
                            ...
                            <Form.Item labelCol={{ span: 5 }} wrapperCol={{ span: 19 }} label="按钮文字">
                                <Input defaultValue={bottomBtnText} onChange={inputChange} maxLength="3"></Input>
                            </Form.Item>
                        </Fragment>
                    }
